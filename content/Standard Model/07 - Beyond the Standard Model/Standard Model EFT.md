...
Moreover, loops involving $hBW$ get modified again due to $\mathcal{O}_{H}$. If the Standard Model loops canceled, in the SMEFT they do not anymore, and we have a divergence, 
$$
