...
Near the $Z$ pole, the measured process is [[Electron-Positron Annihilation]]
$$
...
In order to compare experimental data with theoretical predictions, a fit of the [[Electron-Positron Annihilation#One-loop level cross section|one-loop cross section]] of the process is made.
